...
void dessinerCadreX(int x, int y1, int y2, int z1, int z2){
...
void dessinerCadreY(int x1, int x2, int y, int z1, int z2){
    glBegin(GL_LINE_STRIP);
    glVertex3f(x1, y, z1);
    glVertex3f(x1, y, z2);
    glVertex3f(x2, y, z2);
...
void dessinerCadreZ(int x1, int x2, int y1, int y2, int z){
    glBegin(GL_LINE_STRIP);
    glVertex3f(x1, y1, z);
    glVertex3f(x1, y2, z);
    glVertex3f(x2, y2, z);
...
/* permet d'afficher les hitboxes de chaque entité. la box est centrée sur la pos de l'entité */

void dessinerMaisonsHb(){
    int i;
    point p;
    point minPos, maxPos;
    rect hb;
