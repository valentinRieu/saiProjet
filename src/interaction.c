...
void deplacer(int id, int type){
    ...
    if(type == 0){
        ...
        if(estAutorise(id,i,j,0)){
            ...
            if(i-bonhommes[id].cible.x < 10 && i-bonhommes[id].cible.x > -10 && j-bonhommes[id].cible.y < 10 && j-bonhommes[id].cible.y > -10){
        ...
        if(estAutorise(id,i,j,1)){
            animaux[id].pos.x = i;
            animaux[id].pos.y = j;
            if(i-animaux[id].cible.x < 10 && i-animaux[id].cible.x > -10 && j-animaux[id].cible.y < 10 && j-animaux[id].cible.y > -10){
                animaux[id].isDepl = 0;
            }
        } else{
            animaux[id].isDepl = 0;
